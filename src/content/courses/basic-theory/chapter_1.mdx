...
Unspent cells are live cells; spent cells are dead cells. So, a `CKB` chain keeps on spending and creating cells through transactions, like the renewal and division of cells throughout the body.

![Figure 1. Layered Architecture](https://images.pexels.com/photos/11198507/pexels-photo-11198507.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)

>In the CKB universe, countless cells are floating around.
Cells store data that jointly form the general state of the chain.


Unlike `UTXO`, a cell can store any type of data. Each cell has a field called data, where you can put an
