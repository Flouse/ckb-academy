...
## Reference
- [Nervos Network glossary](https://docs.nervos.org/docs/tech-explanation/glossary) covers a range of topics including blockchain, smart contracts, decentralisation, and more. You could do a quick search when you need it, no need to put all of them into your mind now.
