...
The first official NFT standard to be finalized was ERC721 in early 2018, which was based on what was used for CryptoKitties a few months prior. A few months after that, ERC1155 would be released, which added the ability to create multiple NFT token types in a single contract which streamlined the process for developers of creating multiple NFTs. Led by the success of CryptoKitties, ERC721 and ERC1155 paved the way for future developers to innovate using NFTs without having to "reinvent the wheel".
